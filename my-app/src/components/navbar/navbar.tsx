      ...
      <div className="w-full bg-background px-4 py-1 flex items-center justify-between">
        ...
        <div className="w-fit flex items-center justify-between gap-6">
          ...
          <div className="w-fit flex items-center gap-4">
            ...
            <button className="bg-orange text-white px-4 py-2 rounded-md" onClick={() => window.open('https://drive.google.com/file/d/19JVRbP53htxUW6oULB_aI7XLyJjX43Te', '_blank')}>RESUME</button>
          </div>
        </div>
      </div>
      </div>
